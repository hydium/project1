  ...
  while ((e = list_next (e)) != list_end (&thread_list)) 
    {
      ...
      tw->time_to_wake_up--;
      //printf("name: %s, time: %lld \n", tw->thread_waiting_pointer->name, tw->time_to_wake_up);
...
thread_set_priority (int new_priority) 
{
  ...
  /* If a current thread does not have the highest priority anymore, yield. */
  struct list_elem *e;
